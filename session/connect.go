...
func Connect(f func(ctx context.Context) error, phone string, password string, device telegram.DeviceConfig, apiID int, apiHash string, sessionString string, proxy string) error {
